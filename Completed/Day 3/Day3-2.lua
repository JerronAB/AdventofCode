...
for i=1, #file_content, 2 do move(string.sub(file_content, i, i)) end -- #file_content is equivalent to string.len(file_content)
xcoord, ycoord = 0, 0
for i=2, #file_content, 2 do move(string.sub(file_content, i, i)) end
